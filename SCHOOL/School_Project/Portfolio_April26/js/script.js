...
// card url onclick
card1.addEventListener("click", () => {window.open("https://www.figma.com/design/v0xep4VgutN1D854gAzWf7/SCHOOL-PROJECT-%22Nuit-Rivier%22--Y1P1-?m=auto&t=iwZs7fGEQXOnykIg-1", "_blank");});
card2.addEventListener("click", () => {window.open("https://www.figma.com/design/d2IECM1sqMqqXpnAsHSUxS/PERSONAL-PROJECT-LABUBU--May-1--2026-?m=auto&t=iwZs7fGEQXOnykIg-6", "_blank");});
...
card5.addEventListener("click", () => {window.open("url", "_blank");});
card6.addEventListener("click", () => {window.open("url", "_blank");});
